#!/usr/bin/env node
// ============================================================================
// slack-payload.cjs — Construye el payload Slack Block Kit del reporte de QA.
//
// Extraído de notify-slack.sh: el heredoc node dentro de $(...) ROMPE en el /bin/bash 3.2 de macOS
// (un `"` del JS queda sin cerrar → "unexpected EOF"). Como .cjs es portable a cualquier bash.
//
// Uso:  node slack-payload.cjs <results.json> <device_info> <run_url> <sdk_version> <report.json>
// Imprime el JSON del payload a stdout.
// ============================================================================
const fs = require('fs');
